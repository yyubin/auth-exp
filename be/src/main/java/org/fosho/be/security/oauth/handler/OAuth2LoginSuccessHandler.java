package org.fosho.be.security.oauth.handler;
...
import org.fosho.be.security.domain.user.Role;
import org.fosho.be.security.dto.auth.TokenDto;
import org.fosho.be.security.jwt.TokenProvider;
import org.fosho.be.security.oauth.CustomOAuth2User;
import org.fosho.be.security.service.TokenService;
...
public class OAuth2LoginSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    public String makeRedirectUrl(TokenDto tokenDto, boolean isNewUser) {
        return UriComponentsBuilder.fromUriString("http://localhost:3000/loginwait")  // 프론트엔드 url로 작성할것.
